...
const ProjectItem = ({
  ...
  return (
    <div
      className="relative block items-center justify-center h-[500px]  w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]"
      key={key}
    >
      <Image
